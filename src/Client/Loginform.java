...

{
    ...
    private String ip="172.31.129.21";
    private final int port=5030;
    ...
    Thread validateInterviewee=new Thread(new Runnable() {                          //validating user info 
        @Override
        public void run() 
        {
            while(true)
            {
                try
                {
                    ...
                    while(true)
                    {
                        try
                        {
                            String toRead=din.readUTF();
                            if(toRead.equals("valid"))
                            {
                                new Client1(uname,ip).setVisible(true);
                                disposeWindow();
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbuttonActionPerformed
        ...
        this.uname = usernameField.getText();
